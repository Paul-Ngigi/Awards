...
from .views import IndexView, PostsDetails, vote_post, update_profile, profile, post_site
...
urlpatterns = [
    ...
    path('vote/<int:pk>/', login_required(vote_post), name='votes_view'),  # Url to the vote page,
